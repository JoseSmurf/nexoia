...
impl Serialize for NodeIdentity {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        let saved = SavedIdentity {
            ...
            ml_kem_decapsulation_key_bytes: self
                .ml_kem_keypair
                .decapsulation_key_seed_bytes()
                .to_vec(),
...
impl<'de> Deserialize<'de> for NodeIdentity {
    fn deserialize<D: serde::Deserializer<'de>>(deserializer: D) -> Result<Self, D::Error> {
            ...
            || saved.ml_kem_decapsulation_key.is_some()
        {
            ...
            MlKemKeyPair::from_bytes(
                &saved.ml_kem_encapsulation_key_bytes,
                &saved.ml_kem_decapsulation_key_bytes,
            )
